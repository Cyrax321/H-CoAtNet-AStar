...
Artifact locations (anybody copy from Drive COMPLETE to manuscript — verified 2026-09-04 14:09 BACKUP-DONE-NEW-ONLY):
- Source Colab (read-only): /content/H-CoAtNet-Rebuttal-Clean/results/ (116M: best_hcoatnet.pth 111M, compare.json 233K, confusion_matrix_*.png, dataset_info.json, efficiency.json 1.6K, hcoatnet_acc/loss_curves.png, metrics_hcoatnet_ci.json + metrics_with_ci.json 2.0K, model_training.txt 114K, pr_*.png x7, reliability_*.png x7, results_*.json x7+finals 30-31K), /figures/ (113 top: fig2, fig3a/b/c, fig4, fig5, fig6, fig7, fig8, fig9 130KB, fig10 89KB + gradcam/ 6 maps 96-148K + method.txt 212B), /splits/ (datasheet.md 1.3K + seed42_indices.json 349K FULL + SHA256SUM 100K + test_per_class.csv 205B), /weights/ (10 pth root + ablation/best_noSE.pth 111M), /histories/ (all_histories.json 15K + history_*.json x7 3.2K), /ablation/ (ablation.py 30K + best_noSE.pth 111M + README.md).
- Drive COMPLETE (use this): /content/drive/MyDrive/HCoAtNet_complete_details_and_complete_figures_20260904/ — verified 15:23+ CHECK: results 67 files, figures 119 files, weights pth 11; sizes: results 116M, weights 622M, figures 13M, splits 455K, histories 44K, logs 252K, ablation 34K (ablation.py only — json/Table 5 pending night). Fresh clone 519 objects + full 7x train --seed 42 single T4 (cells 1-29). WARNING: cell 1 hardcodes ROBOFLOW_API_KEY runtime-only — repo env-only, redact before Zenodo/GitHub.
- Drive NEWEST (same 67/119/11, old untouched, verified BACKUP-NEW-DONE): /content/drive/MyDrive/HCoAtNet_ALL_SAVED_20260904_FINAL/results/ + /figures/ + /splits/ + /weights/ + /histories/ + /logs/ + /ablation/.
- Drive mirrors (old, untouched): /content/drive/MyDrive/HCoAtNet_FINAL/ + /content/drive/MyDrive/HCoAtNet_2nd_run/ (same subfolders).
- Take-from map: diagrams/figures/json → COMPLETE/figures/ (fig2_class_distribution, fig3a_acc/loss + fig3c_combined, fig4_confusion_*_raw/norm, fig5_overall+mcc, fig6_heatmap, fig7_roc/pr, fig8_reliability, fig9_bubble+bar, fig10_forest, gradcam/*); metrics/json → COMPLETE/results/ (results_*.json, compare.json, metrics_hcoatnet_ci.json, significance.json, efficiency.json + efficiency_T4_GFT_patch.txt, tables.tex, dedup_report.json); splits → COMPLETE/splits/; weights → COMPLETE/weights/; curves → COMPLETE/histories/.
...
[Current run 2026-09-04 Tesla T4 seed42 n=158 — Ranking: CoAtNet 90.51% (143/158) > H-CoAtNet 89.87% (142/158) > GFT 85.44% > ViT 78.48% > Swin 76.58% > CNN 72.78% > EfficientNet-B0 67.09%. H-CoAtNet bootstrap 95% CI (1000, seed42): acc mean 0.8980 [0.8481-0.9430], bal-acc 0.8609 [0.7914-0.9205], macro-F1 0.8506 [0.7775-0.9116], kappa 0.8663 [0.8027-0.9236]. Ablation DONE 2026-09-06 T4 seed42 n=158 from results/ablation.txt: A0 90.51 MacroF1 85.67 Kappa 87.57 / A1 89.24/84.55/85.92 Drop -0.6pp / A2 89.87/85.38/86.73 Drop 0.0 / A3 88.61/83.14/85.05 Drop -1.3pp / A4 88.61/83.57/85.09 Drop -1.3pp / A5 Full 89.87/85.39/86.72 Drop 0.0 / A6 89.24/84.41/85.85 Drop -0.6pp / A7 89.24/84.33/85.92 Drop -0.6pp. Bootstrap 1000 A5 acc 0.8991 [0.8481-0.9430], A0 0.9043 [0.8544-0.9494]. McNemar vs A5 all ns, DeLong ns except A0 vs A5 p=0.0000 diff -0.0406. Saved to /content/drive/MyDrive/HCoAtNet_ablation_FULL_20260906_151710/results/results_ablation_*.json + metrics_*_ci.json + significance_ablation.json + ablation_table.tex + ablation_summary.csv. Efficiency: params H 29.01M vs CoAt 27.82M, MACs 5.15G vs 4.45G; H slower and less accurate than CoAt — efficiency claim withdrawn per C9. Cover highlights frozen 2196/154/158, hybrid interleave, honest CoAt-best.]

[Update 2026-09-09 — honest positioning (verified from results/model_training.txt + results/ablation.txt). (1) CoAtNet is the best model on the frozen test (90.51%, 143/158); H-CoAtNet is second (89.87%, 142/158). The gap is exactly ONE test image (0.64pp = 1/158) with McNemar p=1.0000 (ns) — the ranking is within noise and we do not claim superiority over CoAtNet anywhere. (2) The full H-CoAtNet (A5) reproduces the proposed model exactly (89.87% in both Table 3 and Table 5); A0 (pure ConvNeXt-T, 90.51%) reproduces CoAtNet's score, confirming protocol consistency. (3) H-CoAtNet's verified advantages are calibration (ECE 8.03%, best of all 8 ablation variants vs 9.27-11.80%), hierarchical pruning that halves tokens (49->24) with zero accuracy loss (A5 vs A2, 89.87% vs 89.87%), and SE-gated scoring beating raw scoring (+0.63pp acc, -3.77pp ECE, A5 vs A6). (4) Efficiency claim stays withdrawn: H-CoAtNet is larger/slower than CoAtNet on every axis (29.01M vs 27.82M, 5.15G vs 4.45G MACs, 8.28 vs 6.92 ms T4). (5) 5-fold CV (H-CoAtNet + CoAtNet, dev n=2350, frozen test n=158 held out, group-aware folds, 30ep seed 42) is the pre-registered arbiter: see R2-4 update below. Manuscript contribution statement reframed around calibration + efficiency-preserving pruning + interpretability, not accuracy leadership.]
...
Files (R1-1): /content/drive/MyDrive/HCoAtNet_complete_details_and_complete_figures_20260904/splits/seed42_indices.json + /content/drive/MyDrive/HCoAtNet_complete_details_and_complete_figures_20260904/splits/test_per_class.csv + /content/drive/MyDrive/HCoAtNet_complete_details_and_complete_figures_20260904/splits/SHA256SUM + /content/drive/MyDrive/HCoAtNet_complete_details_and_complete_figures_20260904/splits/datasheet.md; test jsons at /content/drive/MyDrive/HCoAtNet_complete_details_and_complete_figures_20260904/results/results_hcoatnet.json + /content/drive/MyDrive/HCoAtNet_complete_details_and_complete_figures_20260904/results/results_gft.json + /content/drive/MyDrive/HCoAtNet_complete_details_and_complete_figures_20260904/results/results_coatnet.json + /content/drive/MyDrive/HCoAtNet_complete_details_and_complete_figures_20260904/results/results_swin.json + /content/drive/MyDrive/HCoAtNet_complete_details_and_complete_figures_20260904/results/results_vit.json + /content/drive/MyDrive/HCoAtNet_complete_details_and_complete_figures_20260904/results/results_cnn.json + /content/drive/MyDrive/HCoAtNet_complete_details_and_complete_figures_20260904/results/results_efficientnetb0.json.
...
[Current run results/model_training.txt: H-CoAtNet best val 0.8961 at epoch 9 (train acc 0.9781, train loss 0.5017, val loss 0.7739; tied 0.8961 at epochs 28-30, first-best kept), test evaluated ONCE n=158 acc 0.8987 (89.87%, 142/158, support 32/45/46/22/13). Tables 8-9, confusion matrices (fig4_confusion_*_raw/norm) and Fig.7 ROC/PR + Fig.8 reliability regenerated from that single evaluation (results/results_hcoatnet.json SHA f9dac6e3f420). Original Fig.5 test-per-epoch curve removed; replaced with train/val-only curves fig3a_acc_hcoatnet / fig3b_loss_hcoatnet at 300 dpi.]
Files (R1-2): /content/drive/MyDrive/HCoAtNet_complete_details_and_complete_figures_20260904/figures/fig3a_acc_hcoatnet.png + /content/drive/MyDrive/HCoAtNet_complete_details_and_complete_figures_20260904/figures/fig3b_loss_hcoatnet.png + /content/drive/MyDrive/HCoAtNet_complete_details_and_complete_figures_20260904/figures/fig3c_combined_val_acc.png; histories at /content/drive/MyDrive/HCoAtNet_complete_details_and_complete_figures_20260904/histories/history_hcoatnet.json + /content/drive/MyDrive/HCoAtNet_complete_details_and_complete_figures_20260904/histories/all_histories.json.
...
Response:
Definitive spec = code. H-CoAtNet/proposed_method/train_h_coatnet.py:89 class HCoAtNet, :99-102 stages[0-3] ConvNeXt-Tiny [3,3,9,3] dims [96,192,384,768], :107-108 2x ViT Block 192-d 6-head, :114-119 HierarchicalSE 49->36->24. H-CoAtNet/baselines/train_gft.py:104 blocks[:8] + 3xGALA 75%->50%->25%. H-CoAtNet/baselines/train_coatnet.py ConvNeXt-Tiny baseline. Terms: CoAt=conv+attention principle, CoAtNet=Dai NeurIPS21, ConvNeXt=Liu CVPR22 backbone, H-CoAtNet=ours interleaved early ConvNeXt + 2 ViT + late ConvNeXt + SE-gated top-k. Canonical cites in code comments.
Files (R1-3): /content/drive/MyDrive/HCoAtNet_complete_details_and_complete_figures_20260904/weights/best_hcoatnet.pth + /content/drive/MyDrive/HCoAtNet_complete_details_and_complete_figures_20260904/weights/best_coatnet_baseline.pth + /content/drive/MyDrive/HCoAtNet_complete_details_and_complete_figures_20260904/weights/best_gft_model.pth. [Current run torchinfo (results/model_training.txt): HCoAtNet total 29,012,165 trainable (FLOPs 5.15 GMac, mult-adds 7.74G, input 224x224). Breakdown: stem Conv 4,704; Stage1 3x ConvNeXt 96-ch 3x79,296; Stage2 downsample 73,920 + 3x306,048 (192-ch); 2x ViT Block 192-d 6-head ~2x443,904 (Attn 147,648 + MLP 295,872 + norms); Stage3 downsample 295,296 + 9x1,201,920 (384-ch); Stage4 downsample 1,180,416 + 3x4,763,136 (768-ch); 2x HierarchicalSE 2x74,544; head LN 1,536 + Linear 3,845. Confirms [3,3,9,3] dims [96,192,384,768] + 2ViT + 49->36->24.]
...
Response:
No test label or loss grad used. HierarchicalSE forward-only L2(SE(x)) -> softmax -> topk; :114 int(49*0.75)=36, int(49*0.5)=24, so 49->36 (75% of original) ->24 (50% of original). GFT GALA is attn finite-diff + frozen EMA at test, not loss grad, 3 stages 75%->50%->25% separate. Alg.1 in code comments matches implementation.

IMPORTANT: This forward-only mechanism (no gradient, no test label) directly addresses R1-4. The HierarchicalSE module computes token importance via L2 norm of channel-gated representations, standardized then softmaxed — purely deterministic given input x. At test time, no ground-truth labels or loss gradients are used; the SE gates are frozen from training. This design choice is verified in train_h_coatnet.py:53-81 and is a key causal contribution isolated in the ablation study (A5 vs A6: SE-gated scoring beats raw L2 scoring by +0.63pp acc, -3.77pp ECE). Files (R1-4): /content/drive/MyDrive/HCoAtNet_complete_details_and_complete_figures_20260904/weights/best_hcoatnet.pth (49->36->24 check via torchinfo in model_training.txt).Comment 5:
...
[Current run: dedup_audit.py DONE 2026-09-04: n_total 2508, n_exact 0 (MD5), n_near 0 (5000 sampled pairs, pHash<8), per-split 2196/154/158 confirmed. Cross-split train-vs-test near pairs FOUND (Hamming 0-2, threshold 8 — e.g. IV train 000003 vs test download-3 d=2, IV train vs test 000005 d=2, one d=0 pair) — see dedup_report.json tail + COMPLETE/results/dedup_report.json. Honest leakage flag: image-level split only (no patient IDs), web-source overlap not excluded. Sensitivity DermNet-only: not run. Experts/kappa: manuscript §3.1 to fill.]
...
[No training output for C6 in results/model_training.txt (manuscript/docs only): S1 rows / license IDs / not-redistributed note / IRB basis / consent / Roboflow Restricted screenshot still to fill.]
...
Table 3 below = copy to manuscript. Files (R1-7): /content/drive/MyDrive/HCoAtNet_complete_details_and_complete_figures_20260904/histories/history_hcoatnet.json + /content/drive/MyDrive/HCoAtNet_complete_details_and_complete_figures_20260904/histories/all_histories.json + /content/drive/MyDrive/HCoAtNet_complete_details_and_complete_figures_20260904/results/results_hcoatnet.json.

[Current run n=158 seed42 Tesla T4 (results/model_training.txt + compare.json): H-CoAtNet 89.87% (best val 0.8961 ep9) / CoAtNet 90.51% (best val 0.9026 ep4) / GFT 85.44% (best val 0.8312 ep24) / Swin 76.58% (best val 0.7857 ep21) / ViT 78.48% (best val 0.7078 ep16) / CNN 72.78% (best val 0.7338 ep28) / EfficientNet-B0 67.09% (best val 0.7078 ep29). Ranking: CoAtNet > H-CoAtNet > GFT > ViT > Swin > CNN > Eff. All 30 epochs, AdamW CosineT30, deterministic seed42, val-best + test-once.]

[Matched IN1K + common aug/loss/no-LS re-run: NOT DONE in this log — pending future. Current ranking above is current-recipe only and not claimed as fair (see asymmetry disclosure retained below).]
...
[Update 2026-09-04: current-recipe Table 8 confirmed from compare.json (CoAt 90.51 best, H 89.87 second); matched IN1K + common aug/loss/no-LS re-run still not done. Asymmetry disclosure above retained regardless.]
...
[Current run python tools/bootstrap_ci.py + stats_tests.py (results/model_training.txt): H-CoAtNet point acc 0.8987; bootstrap mean 0.8980 [0.8481-0.9430] sd 0.0247; bal-acc 0.8609 [0.7914-0.9205]; macro-F1 0.8506 [0.7775-0.9116]; weighted-F1 0.8959 [0.8415-0.9412]; kappa 0.8663 [0.8027-0.9236]; MCC 0.8683 [0.8047-0.9246]; AUROC 0.9437 [0.9023-0.9778]; AUPRC 0.8728 [0.7946-0.9411]. McNemar (ref=H): vs GFT p=0.1213 ns (chi2 2.40 [[131,11],[4,12]]); vs CoAtNet p=1.0000 ns (chi2 0.00 [[138,4],[5,11]]); vs Swin p=0.0000 **; vs ViT p=0.0019 **; vs CNN p=0.0000 **; vs Eff p=0.0000 **. DeLong-like (bootstrap 1000): vs GFT p=0.586 ns (diff -0.0072); vs CoAt p=0.0140 * (diff -0.0294 favours CoAt); vs Swin p=0.234 ns; vs ViT p=0.476 ns; vs CNN p=0.070 ns; vs Eff p=0.0040 **. Hence H significantly better than Swin/ViT/CNN/Eff (McNemar) but NOT than GFT or CoAtNet; CoAtNet point higher and AUROC significantly higher. No superiority claim over CoAtNet. LaTeX row: H-CoAtNet & 89.87 [84.8--94.3] & 0.861 [0.791--0.921] & 0.851 [0.777--0.912] & 0.866 [0.803--0.924]. Saved results/metrics_with_ci.json + significance.json.]

[Update 2026-09-09 — second uncertainty pillar (K-fold, COMPLETED). Bootstrap CIs above quantify test-sampling noise on the single split; they cannot quantify split-sampling noise, which matters here because the entire H-CoAtNet vs CoAtNet ranking rests on ONE test image (143/158 vs 142/158, McNemar p=1.0000). The 5-fold CV (H-CoAtNet + CoAtNet, protocol in R2-4 update) supplies mean+/-SD across data partitions and is the evidentiary basis for any ranking claim. Until it lands, all superiority language stays removed and the paper reports the tie honestly.]

[Single-seed 42 + bootstrap 1000 DONE all 7 (2026-09-04, no retrain, from saved y_true/y_pred): H 89.87 [84.8-94.3] bal 0.861 [0.791-0.921] F1 0.851 [0.777-0.912] kap 0.866 [0.803-0.924]; CoAt 90.51 [85.4-94.9] bal 0.881 [0.819-0.934] F1 0.868 [0.798-0.928] kap 0.876 [0.814-0.934]; GFT 85.44 [79.7-90.5] bal 0.792 [0.715-0.863] F1 0.782 [0.702-0.859] kap 0.810 [0.741-0.877]; ViT 78.48 [72.2-84.2]; Swin 76.58 [70.2-82.9]; CNN 72.78 [65.8-79.1]; Eff 67.09 [59.5-74.1]. Leaky minus-6 bounds (6/158=3.8%): H 0.8947-0.9342, CoAt 0.9013-0.9408, GFT 0.8487-0.8882 — ranking CoAt>H>GFT holds even worst-case. Take-from: console output COLAB_LEAKY_FIXED.txt 14:xx + /content/drive/MyDrive/HCoAtNet_complete_details_and_complete_figures_20260904/results/leaky_bounds.txt DONE (SAVED-LEAKY). Fig10 regen DONE 15:23 real all-7 24K at /content/drive/MyDrive/HCoAtNet_complete_details_and_complete_figures_20260904/figures/fig10_forest_ci.png (means CoAt 90.53/H 89.80/GFT 85.52/ViT 78.44/Swin 76.55/CNN 72.62/Eff 67.18).]
Files (R1-8): /content/drive/MyDrive/HCoAtNet_complete_details_and_complete_figures_20260904/results/metrics_hcoatnet_ci.json + /content/drive/MyDrive/HCoAtNet_complete_details_and_complete_figures_20260904/results/metrics_gft_ci.json + /content/drive/MyDrive/HCoAtNet_complete_details_and_complete_figures_20260904/results/metrics_coatnet_ci.json + /content/drive/MyDrive/HCoAtNet_complete_details_and_complete_figures_20260904/results/metrics_swin_ci.json + /content/drive/MyDrive/HCoAtNet_complete_details_and_complete_figures_20260904/results/metrics_vit_ci.json + /content/drive/MyDrive/HCoAtNet_complete_details_and_complete_figures_20260904/results/metrics_cnn_ci.json + /content/drive/MyDrive/HCoAtNet_complete_details_and_complete_figures_20260904/results/metrics_efficientnetb0_ci.json + /content/drive/MyDrive/HCoAtNet_complete_details_and_complete_figures_20260904/results/significance.json (all-7 DONE 14:39, SAVED-ALL7).
...
Batch size 1 (T4; prior measurement retained for 6 models, GFT re-measured 2026-09-04 same T4 setup; test-acc column current run 2026-09-04 n=158):

  Model            Params (M)   MACs (G)   Latency (ms)   Throughput (img/s)   Peak mem (GB)   Test acc (%)
  H-CoAtNet        29.01        5.15       8.28           120.8                0.13            89.87 (was 88.61 draft)
  CoAtNet          27.82        4.45       6.92           144.4                0.35            90.51
  GFT               6.16        2.90       7.44           134.5                0.03            85.44 (was 86.08 draft)
...
These measurements do not support the original claim. Relative to the ConvNeXt-Tiny baseline, H-CoAtNet uses more parameters (29.01 vs 27.82 M), more MACs (5.15 vs 4.45 G) and higher batch-1 latency (8.28 vs 6.92 ms T4; 324.7 vs 120.3 ms CPU in current log) while achieving lower test accuracy (89.87 vs 90.51 % current run, n=158). It is therefore dominated on every measured axis. The statements that the proposed architecture improves performance "with no corresponding increase in computational cost" and offers an optimal accuracy-efficiency trade-off are incorrect, and we have deleted them from the Abstract, Results and Conclusion.

Two measurement caveats are reported rather than concealed. (a) thop.profile() fails on GFT/GALA (tuple return + Conv1d smoother: "'Conv2d' object has no attribute 'total_ops'"), so GFT T4 latency/peak were re-measured 2026-09-04 with a latency-only cell (GFT_FILL_FIX.txt, no thop) under identical conditions (Tesla T4, torch 2.11.0+cu128, 224x224, b1, mean 100 runs after 20 warmup with CUDA sync, max_memory_allocated): b1 7.44 ms / 134.5 img/s / 0.03 GB; b32 24.8 ms / 0.10 GB. Params/MACs (6.16M/2.90G) are device-independent from CPU run and retained. (b) Batch-1 peak memory is sensitive to allocator state and measurement order, so only the batch-32 peak-memory figures should be compared across models: H-CoAtNet 0.64, CoAtNet 0.75, GFT 0.10, Swin 1.12, ViT 0.43, CNN 2.25, EfficientNet-B0 0.74 GB.

Efficiency claim withdrawn per Reviewer 1, Comment 9: H-CoAtNet is larger/slower than CoAtNet on every axis (29.01M vs 27.82M params, 5.15G vs 4.45G MACs, 8.28 vs 6.92 ms T4). No accuracy-efficiency trade-off is claimed.Comment 10:
...
[Current run tools/generate_tables.py --all + finalize (results/model_training.txt): compare.json acc — H-CoAtNet 89.87 / GFT 85.44 / CoAtNet 90.51 / Swin 76.58 / ViT 78.48 / CNN 72.78 / EfficientNet-B0 67.09 (n=158, SHA f9dac6e3/bd64579e/907ea179/d0d030ca/a82220d2/48f20406/7bd298a7). Table 8 = these values. Table 9 H-CoAtNet: Harlequin P 0.9677 / R 0.9375, Healthy 0.9783/1.0000, IV 0.8958/0.9348, Lamellar 0.8125/0.5909, Netherton 0.6471/0.8462; CoAtNet (best): Harlequin 0.9667/0.9062, LI 0.7778/0.6364, NS 0.7059/0.9231. Fig.7 ROC/PR x7 + Fig.8 reliability x7 + Fig.4 confusion raw/norm x7 + Fig.6 per-class F1 heatmap + Fig.5 ranking + Fig.10 forest CI all regenerated (Fig.9 efficiency initially KeyError 'acc' then succeeded as bubble+bar).]
Files (R1-10): /content/drive/MyDrive/HCoAtNet_complete_details_and_complete_figures_20260904/results/compare.json + /content/drive/MyDrive/HCoAtNet_complete_details_and_complete_figures_20260904/results/tables.tex; confusion at /content/drive/MyDrive/HCoAtNet_complete_details_and_complete_figures_20260904/results/confusion_matrix_hcoatnet.png + /content/drive/MyDrive/HCoAtNet_complete_details_and_complete_figures_20260904/figures/fig4_confusion_hcoatnet_raw.png + /content/drive/MyDrive/HCoAtNet_complete_details_and_complete_figures_20260904/figures/fig4_confusion_hcoatnet_norm.png; ROC at /content/drive/MyDrive/HCoAtNet_complete_details_and_complete_figures_20260904/figures/fig7_roc_hcoatnet.png + /content/drive/MyDrive/HCoAtNet_complete_details_and_complete_figures_20260904/results/pr_hcoatnet.png; reliability at /content/drive/MyDrive/HCoAtNet_complete_details_and_complete_figures_20260904/figures/fig8_reliability_hcoatnet.png + /content/drive/MyDrive/HCoAtNet_complete_details_and_complete_figures_20260904/results/reliability_hcoatnet.png; overall at /content/drive/MyDrive/HCoAtNet_complete_details_and_complete_figures_20260904/figures/fig5_overall_comparison.png; per-class at /content/drive/MyDrive/HCoAtNet_complete_details_and_complete_figures_20260904/figures/fig6_perclass_f1_heatmap.png.

After results updated, update manuscript: Abstract=Table8=Conclusion=compare.json, fix 90.51/89.24 to current-run H 89.87 / CoAt 90.51 (n=158), 100%/perfect to H recall 0.9375 (30/32) / CoAt 0.9062 (29/32), LI/NS text to H table values (LI P 0.8125/R 0.5909, NS P 0.6471/R 0.8462), 4-vs-6 to 7 names, CoAt 74.68% clarified as stale draft (current 90.51%), Fig7 all 7 models.
...
[Current run 2026-09-04 14:03-14:04 T4 DONE: figures/gradcam/ 6 maps (gradcam_0_true0_pred0, gradcam_1_true0_pred0, gradcam_2_true0_pred0, gradcam_16_true0_pred4, gradcam_18_true0_pred3, gradcam_105_true2_pred4) + method.txt (cnn_stage4 7x7, pred-logit, min-max, jet 0.45); all figs regenerated Fig2/Fig3c/Fig4/Fig5/Fig6/Fig7/Fig8/Fig9 130KB bubble/Fig10 89KB forest, 113 files saved to Drive/HCoAtNet_FINAL/figures/. No test-label use for maps.]
Files (R1-11): /content/drive/MyDrive/HCoAtNet_complete_details_and_complete_figures_20260904/figures/gradcam/gradcam_0_true0_pred0.png + /content/drive/MyDrive/HCoAtNet_complete_details_and_complete_figures_20260904/figures/gradcam/gradcam_105_true2_pred4.png + /content/drive/MyDrive/HCoAtNet_complete_details_and_complete_figures_20260904/figures/gradcam/method.txt; ROC at /content/drive/MyDrive/HCoAtNet_complete_details_and_complete_figures_20260904/figures/fig7_roc_hcoatnet.png; reliability at /content/drive/MyDrive/HCoAtNet_complete_details_and_complete_figures_20260904/figures/fig8_reliability_hcoatnet.png.

To be written: manuscript downgrade reliable/telederm/decision-support to future-utility prototype; attention texture/fissures as hypothesis unless blinded expert rates [pending]/6 plausible. No external/prospective/reader study in this code.
...
[Current run confirms wording must be 'CoAtNet best among 7 (90.51%), H-CoAtNet second (89.87%)' — not SOTA. Manuscript S4 3-paper table / .bib canonical / remove 1998/2002/2010 still to fill — no training output.]
...
[Zenodo source = Drive COMPLETE 20260904 (anybody copy): /content/drive/MyDrive/HCoAtNet_complete_details_and_complete_figures_20260904/weights/best_*.pth x11 (incl noSE), /results/results_*.json x7 (SHA f9dac6e3/bd64579e/907ea179/d0d030ca/a82220d2/48f20406/7bd298a7) + compare.json + metrics_with_ci.json + metrics_hcoatnet_ci.json + significance.json + efficiency.json + results/efficiency_T4_GFT_patch.txt (GFT b1 7.44/134.5/0.03) + tables.tex + results/dedup_report.json DONE (n_exact 0/n_near 0 + 6 cross-split IV pairs d=0-2, TOPPED-UP2), /figures/ (77 png + 34 pdf + gradcam/ 6+method.txt), /splits/ (349K FULL + SHA). Ablation DONE 2026-09-06: /content/drive/MyDrive/HCoAtNet_ablation_FULL_20260906_151710/results/results_ablation_*.json x8 + metrics_*_ci.json x8 + significance_ablation.json + ablation_table.tex + ablation_summary.csv/json + tables_ablation.tex (A0 90.51 / A5 Full 89.87). Zenodo DOI / configs / code-version / S1 IDs / Funding APC still manuscript/ops to fill.]
...
[Code done (HCoAtNet/BaselineCNN renames, zero H-Coat-Net in *.py, dims 49->36->24, curves 300 dpi train/val); manuscript still to fill: (1) typos propoed/basseline/superiour + Tehnologoical fixed, (2) Fair CNN->Baseline CNN apply in text, (3) dermatological/clinical not dermoscopic, (4) language service/none stated, Fig.1 redraw with tensor shapes B x C x H x W / B x N x C from train_h_coatnet.py:96-133.]
...
[Current run 2026-09-04: test H 89.87% (142/158) / val-best 0.8961 ep9; CoAt 90.51% / val 0.9026 ep4 (best overall); bootstrap H acc 0.8980 [0.8481-0.9430]; dedup DONE n_exact 0/n_near 0 + 6 cross-split IV d=0-2 (COMPLETE/results/dedup_report.json); all tables/Figs from compare.json (SHA above). Manuscript moderation per C11/12 still to apply.]
...
[Current run: test distribution confirmed 2196-train-consistent / 154-val-consistent / 158-test (32 Harlequin / 45 Healthy / 46 IV / 22 Lamellar / 13 Netherton) in all 7 evaluations; freeze_split per-class table to paste from /content/drive/MyDrive/HCoAtNet_complete_details_and_complete_figures_20260904/splits/test_per_class.csv + /content/drive/MyDrive/HCoAtNet_complete_details_and_complete_figures_20260904/splits/seed42_indices.json. Manuscript §3.1 still to write [AUTHORS TO FILL — not in training log]: sources incl. DermNet/Shutterstock + S1 IDs; labels by [who] blinded [y/n], disagreements [n]/kappa [__]; ethics IRB [id]/basis [__] + consent [__].]]
...
[Code: HCoAtNet vs CoAtNet baseline renamed; borrowed ConvNeXt-Tiny [3,3,9,3]/ViT/SE vs new interleave + 2xViT 192-d + HierarchicalSE L2 top-k 49->36->24. Manuscript Box1 glossary + Borrowed/New para + baseline labelling still to write; ablation take-from /content/drive/MyDrive/HCoAtNet_ablation_FULL_20260906_151710/weights/best_*.pth x8 + results/results_ablation_*.json x8 + ablation_table.tex (A0 90.51 / A1 89.24 / A2 89.87 / A3 88.61 / A4 88.61 / A5 Full 89.87 / A6 89.24 / A7 89.24, McNemar all ns).]

[Update 2026-09-09 — what the ablation causally isolates (all McNemar ns, so read deltas + calibration, not stars). (i) Hierarchical SE pruning preserves accuracy while halving tokens: A5 (49->36->24) == A2 (no pruning) at 89.87%; naive pruning destroys it (A3 random / A4 one-shot L2 both 88.61%, -1.3pp) — the manner of selection is the contribution. (ii) SE gating improves the importance signal itself: A5 beats A6 (raw-L2 scoring, same hierarchy) by +0.63pp accuracy and -3.77pp ECE (8.03% vs 11.80%). (iii) ViT blocks add +0.63pp over A7 (89.87 vs 89.24). (iv) Full model is the best-calibrated of all 8 variants (ECE 8.03% vs 9.27-11.80%) — the clinically relevant edge, since reliable confidence underpins triage. Novelty statement for §1: interleaved ConvNeXt+ViT backbone is borrowed; the new component is SE-gated hierarchical token selection with forward-only L2 scoring, ablated as above.]
...
[Current finalize Table 8 n=158: H 89.87 / CoAt 90.51 (best) / GFT 85.44 / ViT 78.48 / Swin 76.58 / CNN 72.78 / Eff 67.09. Manuscript must set Abstract=Table8=Conclusion to these; delete 89.24 and H-90.51; H-Coat-Net->H-CoAtNet done in code (zero hits in *.py).]
...
[Update 2026-09-09 — 5-fold CV protocol (R2-4 second half). Design: development pool = train+valid (n=2350); frozen test (n=158) excluded from all folds per TRIPOD-AI Type 2b; group-aware StratifiedGroupKFold (k=5, seed 42) with filename-stem identity grouping so augmented copies never leak across folds; 2 models only — H-CoAtNet (proposed) and CoAtNet (sole rival within noise; A0's 90.51% is the same ConvNeXt-T backbone story, ViT/Swin/CNN/EffNet already McNemar p<0.001 so CV cannot change their ranking); identical 30-epoch protocol; val-best checkpoint per fold evaluated once on frozen test. Tool: H-CoAtNet/tools/kfold/kfold.py (auto per-fold banners, running leaderboard, final ranked table; Drive-resume via --resume). Outputs: results/kfold/kfold_table.tex (Table 6), kfold_test_summary.csv (Suppl. Table SX), kfold_paired_tests.json (Wilcoxon), kfold_friedman_nemenyi.json, 13 figures incl. frozen-test accuracy bars + reliability + critical-difference diagram.
RESULTS (5-fold CV, group-aware StratifiedGroupKFold k=5, seed 42, dev pool n=2350, frozen test n=158, TRIPOD-AI Type 2b, 30 epochs, val-best ckpt per fold):

H-CoAtNet (proposed):
  Validation:  Acc 89.81+/-1.65  MacroF1 87.76+/-1.40  BalAcc 87.27+/-1.56
               Per-fold: [90.7, 88.8, 89.0, 92.3, 88.3]
  Frozen Test: Acc 89.11+/-1.97  MacroF1 83.69+/-2.94  Kappa 0.8576+/-0.0260
               Per-fold: [86.71, 87.34, 89.87, 91.14, 90.51]

CoAtNet:
  Validation:  Acc 90.23+/-1.76  MacroF1 87.79+/-2.00  BalAcc 87.49+/-2.52
               Per-fold: [91.8, 88.8, 89.2, 92.5, 88.9]
  Frozen Test: Acc 89.75+/-0.28  MacroF1 85.02+/-0.36  Kappa 0.8658+/-0.0038
               Per-fold: [89.87, 89.87, 89.87, 89.87, 89.24]

CNN:
  Frozen Test: Acc 71.77+/-1.06  Kappa 0.6300+/-0.0141

GFT:
  Frozen Test: Acc 84.56+/-2.48  Kappa 0.7991+/-0.0325

Final Leaderboard (Frozen Test Acc, mean+/-SD):
  1. CoAtNet          89.7+/-0.3
  2. H-CoAtNet        89.1+/-2.0 *
  3. GFT              84.6+/-2.5
  4. CNN              71.8+/-1.1

Interpretation (pre-registered): H-CoAtNet and CoAtNet are statistically tied on frozen test (overlapping CIs: H 89.11+/-1.97 vs CoAt 89.75+/-0.28). CoAtNet shows lower variance (0.28 vs 1.97 SD). H-CoAtNet contribution is calibration (ECE 8.03%), 50% token reduction at zero accuracy loss, and GradCAM interpretability — not accuracy leadership. No accuracy superiority claimed over CoAtNet.

Statistical tests: Wilcoxon signed-rank (paired, val-best ckpt per fold on frozen test) and Friedman/Nemenyi across 4 models available in kfold_paired_tests.json / kfold_friedman_nemenyi.json.]
Files (R2-4): /content/drive/MyDrive/HCoAtNet_complete_details_and_complete_figures_20260904/results/metrics_hcoatnet_ci.json + /content/drive/MyDrive/HCoAtNet_complete_details_and_complete_figures_20260904/results/metrics_gft_ci.json + /content/drive/MyDrive/HCoAtNet_complete_details_and_complete_figures_20260904/results/metrics_coatnet_ci.json + /content/drive/MyDrive/HCoAtNet_complete_details_and_complete_figures_20260904/results/metrics_swin_ci.json + /content/drive/MyDrive/HCoAtNet_complete_details_and_complete_figures_20260904/results/metrics_vit_ci.json + /content/drive/MyDrive/HCoAtNet_complete_details_and_complete_figures_20260904/results/metrics_cnn_ci.json + /content/drive/MyDrive/HCoAtNet_complete_details_and_complete_figures_20260904/results/metrics_efficientnetb0_ci.json + /content/drive/MyDrive/HCoAtNet_complete_details_and_complete_figures_20260904/results/significance.json; forest at /content/drive/MyDrive/HCoAtNet_complete_details_and_complete_figures_20260904/figures/fig10_forest_ci.png (DONE 15:23 real all-7 24K); k-fold completed — results landed at /content/drive/MyDrive/HCoAtNet_complete_details_and_complete_figures_20260904/results/ + /content/drive/MyDrive/HCoAtNet_complete_details_and_complete_figures_20260904/figures/ (H-CoAtNet test 89.11+/-1.97, CoAtNet test 89.75+/-0.28, tied; H-CoAtNet higher variance 1.97 vs 0.28 SD).
...
[Manuscript only (zero Hauser/Chanda in *.py): fix [9] to Chanda + in-text match; verify via Semantic Scholar — still to fill.]
...
[Manuscript only (canonical cites only in *.py :87, zero 1998/2002/2010 hits): replace with Vaswani/He/Dosovitskiy etc.; keep only sentence-supporting refs — still to fill.]
...
[Code done where code can: H-SE vs GALA separated, 7 confusion + per_class + fig4/fig6/S2, curves 300 dpi train/val, zero CC BY in *.py. Manuscript still to write: typos/Tehnologoical, Related split §2/§3, funding APC, clinical prototype, Fig.1 redraw, Restricted not CC-BY.]
...
K-fold and statistical consistency: Bootstrap 1000 CIs and McNemar/DeLong significance tests are provided for all models (results/significance.json, results/metrics_hcoatnet_ci.json). K-fold cross-validation (R2-4 second half) COMPLETED — 5-fold group-aware StratifiedGroupKFold k=5 seed 42, dev pool n=2350 (train+valid), frozen test n=158 held out (TRIPOD-AI Type 2b), 30 epochs, val-best checkpoint per fold evaluated once on frozen test.

Results (frozen test, mean+/-SD):
  H-CoAtNet: Acc 89.11+/-1.97, MacroF1 83.69+/-2.94, Kappa 0.8576+/-0.0260
  CoAtNet:   Acc 89.75+/-0.28, MacroF1 85.02+/-0.36, Kappa 0.8658+/-0.0038
  GFT:       Acc 84.56+/-2.48, Kappa 0.7991+/-0.0325
  CNN:       Acc 71.77+/-1.06, Kappa 0.6300+/-0.0141

Per-fold frozen test accuracies:
  H-CoAtNet: [86.71, 87.34, 89.87, 91.14, 90.51]
  CoAtNet:   [89.87, 89.87, 89.87, 89.87, 89.24]

Interpretation (pre-registered): H-CoAtNet and CoAtNet are statistically tied on frozen test (overlapping CIs). CoAtNet shows lower variance (0.28 vs 1.97 SD). H-CoAtNet contribution = calibration (ECE 8.03%) + 50% token reduction at zero loss + GradCAM interpretability — not accuracy leadership. No accuracy superiority claimed over CoAtNet.

Supplement Table SX (kfold_test_summary.csv) contains full per-fold metrics. Wilcoxon + Friedman/Nemenyi in kfold_paired_tests.json / kfold_friedman_nemenyi.json.

Numerical consistency: Single source of truth — compare.json drives Abstract, Table 8, and Conclusion (H 89.87% / CoAt 90.51%). No superiority claimed over CoAtNet; ranking within noise of one test image (0.64pp gap, McNemar p=1.0000). Ablation contributions confirmed: hierarchical SE pruning preserves accuracy (A5 vs A2), SE-gated scoring improves calibration (A5 vs A6: +0.63pp acc, -3.77pp ECE), efficiency claim withdrawn per C9 (H larger/slower on all axes). All conclusions moderated to describe prototype utility, not demonstrated clinical capability.